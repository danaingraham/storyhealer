        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <Link href="/" className="inline-flex items-center space-x-2 mb-6">
              ...
              <span className="font-fredoka text-3xl font-bold text-gradient">
                StoryHealer
              </span>
            </Link>
            ...
            <p className="text-gray-600">
              Sign in to create magical stories for your child
            </p>
          </div>

          <button
            onClick={() => signIn("google", { callbackUrl })}
            className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-300 rounded-lg px-6 py-3 text-gray-700 font-medium hover:bg-gray-50 transition-colors"
          >
